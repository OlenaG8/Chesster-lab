...
def pick_top_two_contours_by_square(contours, mask_board):
    ...
    for c in contours:
        ...
        # Bias: use center-top of the bounding box (top of the piece) — 30..40% of height
...
def main():
    ...
    try:
        while not board.is_game_over():
            ...
            new_sq_points = get_chessboard_state(frame_raw)
            if new_sq_points is not None:
                sq_points = new_sq_points
            elif not sq_points:
                cv2.imshow("Chess Tracker", frame_raw)
            ...
            if key == ord('r'):
                if ref_frame is None:
                    ...
                    # more universal version (for ivory white and black/brown)
                    ...
                    # helper: create a list of candidate squares for a contour
                    ...
                    # visual debug: show selected squares and points
                        ...
                        if piece_now:
                            ...
                            if not found:
                                for df in (-1, 0, 1):
                                    ...
                                    if found:
                                        break
                            # if still None, from_sq remains None and will be considered invalid
                        ...
                        try:
                            ...
                            if mv in board.legal_moves:
                                ...
                                try:
                                    ...
                                    # don't crash if key is not in sq_points (safety)
                                    if DEBUG_MODE:
